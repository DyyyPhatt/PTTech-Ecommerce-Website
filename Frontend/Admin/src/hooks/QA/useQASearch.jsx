...
const useQASearch = () => {
  ...
  useEffect(() => {
    const history = JSON.parse(localStorage.getItem("qaearchHistory")) || [];
  ...
  useEffect(() => {
    if (searchQuery.trim() !== "") {
      setSearchHistory((prevHistory) => {
        ...
        localStorage.setItem("qaearchHistory", JSON.stringify(historyToSave));
