...
import useAddAdSchedule from "../../hooks/Ads/useAddAdSchedule";
  ...
  return (
    <>
      ...
      >
        {showErrorMessage && (
          ...
          >
            ...
            <div className="ml-3 text-sm font-normal dark:text-white">
              Thêm lịch quảng cáo thất bại. Vui lòng thử lại!
            </div>
          </div>
        )}
        ...
        <div className="grid mt-6 gap-6 mb-6 md:grid-cols-2">
          <div>
            <label
              htmlFor="startDate"
              className="block mb-2 text-sm font-medium text-gray-900 dark:text-white flex items-center"
        ...
        <div className="flex mt-6 justify-center">
          ...
          >
            {isSubmitting ? "Đang đặt lịch..." : "Đặt lịch quảng cáo"}
          </button>
        </div>
      </form>
      <div className="mt-4">
...
export default AddAdScheduleForm;
