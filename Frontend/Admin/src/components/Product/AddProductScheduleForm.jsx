...
import useAddProductSchedule from "../../hooks/Product/useAddProductSchedule";
      ...
      >
        {showErrorMessage && (
          <div className="fixed top-4 right-4 p-4 bg-red-500 text-white rounded">
            Đặt lịch sản phẩm thất bại. Vui lòng thử lại!
          </div>
        )}
        {showSuccessMessage && (
          <div className="fixed top-4 right-4 p-4 bg-green-500 text-white rounded">
            Đặt lịch sản phẩm thành công!
          </div>
        )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-3">
            <div>
              ...
              <input
                ...
                value={formatNumber(schedule.pricing.original)}
                onChange={(e) =>
                  handleChange({
                    target: {
                      name: "pricing.original",
            ...
            <div>
              ...
              <input
                ...
                value={formatNumber(schedule.pricing.current)}
                onChange={(e) =>
                  handleChange({
                    target: {
                      name: "pricing.current",
        ...
        <div className="border-b pb-4 mb-6 border-gray-300 dark:border-gray-700">
          ...
          <div>
            ...
            {schedule.tags.map((tag, index) => (
              <div key={index} className="flex items-center mb-2">
                <input
                  ...
                  className="border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white text-sm rounded-lg p-2.5 w-full mr-2 bg-white dark:bg-gray-800"
                />
                <button
                  type="button"
                  onClick={() => {
                    const updated = [...schedule.tags];
                    updated.splice(index, 1);
                    setSchedule((prev) => ({ ...prev, tags: updated }));
                  }}
            ...
            <button
              type="button"
              onClick={() =>
                setSchedule((prev) => ({ ...prev, tags: [...prev.tags, ""] }))
              }
        ...
        <div className="border-b pb-4 mb-6 border-gray-300 dark:border-gray-700">
          ...
          {Object.entries(schedule.specifications).map(
            ([key, value], index) => (
              <div key={index} className="flex items-center gap-2 mb-2">
                ...
                <button
                  type="button"
                  onClick={() => {
                    const updatedSpecs = { ...schedule.specifications };
          ...
          <button
            ...
            className="text-white bg-blue-500 hover:bg-blue-700 font-medium rounded-lg text-sm px-4 py-2 mt-2 block w-300"
          >
        ...
        <div className="border-b pb-4 mb-6 border-gray-300 dark:border-gray-700">
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              value={schedule.blog.description}
              onChange={handleChange}
              className="bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5"
        ...
        <div className="border-b pb-4 mb-6 border-gray-300 dark:border-gray-700">
          ...
          <div className="mt-3">
            ...
            <input
              ...
              value={schedule.warranty.duration}
              onChange={handleChange}
              className="bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
        ...
        <div className="border-b pb-4 mb-6 border-gray-300 dark:border-gray-700">
          ...
          {schedule.variants.map((variant, index) => (
            <div
              key={index}
            ...
            >
              ...
              <button
                type="button"
                onClick={() => {
                  const updated = [...schedule.variants];
                  updated.splice(index, 1);
                  setSchedule((prev) => ({ ...prev, variants: updated }));
                }}
        ...
        <div className="flex justify-center">
          ...
          >
            {isSubmitting ? "Đang đặt lịch..." : "Đặt lịch sản phẩm"}
          </button>
        </div>
      </form>
      <div className="mt-4">
...
export default AddProductScheduleForm;
