...
import useAddContactSchedule from "../../hooks/Contact/useAddContactSchedule";
    ...
    <>
      ...
      >
        {showErrorMessage && (
          ...
          >
            ...
            <div className="ml-3 text-sm font-normal">
              Đặt lịch liên hệ thất bại. Vui lòng thử lại!
            </div>
          </div>
        )}
        ...
        <div className="grid gap-6 mb-6 md:grid-cols-2">
          ...
          <div>
            <label
              ...
              className="block mb-2 text-sm font-medium text-gray-900 dark:text-white flex items-center"
            >
              <FaTag className="mr-2 text-green-500" /> Zalo
            </label>
            <input
              type="text"
              id="socialMedia.zalo"
          ...
          <div>
            <label
              ...
              className="block mb-2 text-sm font-medium text-gray-900 dark:text-white flex items-center"
            >
              <FaCalendarAlt className="mr-2 text-red-500" /> Giờ làm việc (Thứ
              Hai đến Thứ Sáu)
            </label>
            <input
              type="text"
          ...
          <div>
            <label
              ...
              className="block mb-2 text-sm font-medium text-gray-900 dark:text-white flex items-center"
            >
              <FaCalendarAlt className="mr-2 text-gray-500" /> Giờ làm việc
              (Cuối tuần)
            </label>
            <input
              type="text"
          ...
          <div>
            ...
            >
              <FaCalendarAlt className="mr-2 text-red-500" /> Thời gian lên lịch
            </label>
            <input
              type="datetime-local"
              id="scheduledDate"
              name="scheduledDate"
              value={convertUtcToLocalFormat(contact.scheduledDate) || ""}
              onChange={handleChange}
              className="bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
              required
            />
        ...
        <div className="flex justify-center">
          ...
          >
            {isSubmitting ? "Đang thêm..." : "Đặt lịch liên hệ"}
          </button>
        </div>
      </form>
      <div className="mt-4">
...
export default AddContactScheduleForm;
