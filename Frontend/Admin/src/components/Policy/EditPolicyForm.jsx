...
import useEditPolicy from "../../hooks/Policy/useEditPolicy";
    ...
    <>
      ...
      >
        {showErrorMessage && (
          ...
          >
            ...
            <div className="ml-3 text-sm font-normal">
              Sửa chính sách thất bại. Vui lòng thử lại!
            </div>
          </div>
        )}
        ...
        <div>
          <label
            htmlFor="content"
            className="block mb-2 mt-6 text-sm font-medium text-gray-800 dark:text-white flex items-center"
          >
        ...
        <div className="flex mt-6 justify-center">
          ...
          >
            {isSubmitting ? "Đang sửa..." : "Cập nhật chính sách"}
          </button>
        </div>
      </form>
      <div className="mt-4">
