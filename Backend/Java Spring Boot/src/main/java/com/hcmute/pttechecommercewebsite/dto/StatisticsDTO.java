...
public class StatisticsDTO {
    ...
    private String id;                            // ID duy nhất của thống kê
    ...
    private List<ProductSalesDTO> topSellingProducts;   // Sản phẩm bán chạy
    ...
    private CustomerFeedbackDTO customerFeedback;           // Thông tin về đánh giá của khách hàng
    ...
    private int totalCancelations;                          // Tổng số đơn hàng bị hủy
    ...
    @AllArgsConstructor
    @Builder
    public static class CustomerFeedbackDTO {
